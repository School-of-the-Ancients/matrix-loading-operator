...
$editorFiles = @('SandboxCoreChecks.cs', 'SandboxContentChecks.cs', 'SandboxContentPackExporter.cs', 'SandboxPrefabPreview.cs', 'SandboxProjectSetup.cs', 'LessonGuideChecks.cs', 'DesktopValidationBuild.cs')
foreach ($group in @(
