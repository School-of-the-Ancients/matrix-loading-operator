...
test('WebXR advertises virtual-only capture and returns the requested image once',async()=>{
  ...
  assert.equal(requests[0].captureCapabilities.mixedStatus,'unsupported');
