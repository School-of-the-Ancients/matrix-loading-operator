...
$AgentApprovals = $AgentApprovals.ToLowerInvariant()
...
$names = 'SANDBOX_AI_MODE', 'SANDBOX_CODEX_EXE', 'SANDBOX_CODEX_MODEL', 'SANDBOX_CODEX_AGENT_SANDBOX', 'SANDBOX_CODEX_AGENT_APPROVAL_POLICY', 'SANDBOX_CODEX_WINDOWS_SANDBOX', 'CODEX_API_KEY', 'OPENAI_API_KEY', 'MATRIX_CONTENT_CONFIG', 'MATRIX_CONTENT_CACHE', 'SANDBOX_SPEECH_PYTHON', 'SANDBOX_SPEECH_MODEL'
$previous = @{}
...
try {
    ...
    [Environment]::SetEnvironmentVariable('SANDBOX_CODEX_AGENT_APPROVAL_POLICY', $(if ($AgentApprovals -eq 'automatic') { 'never' } else { 'on-request' }), 'Process')
