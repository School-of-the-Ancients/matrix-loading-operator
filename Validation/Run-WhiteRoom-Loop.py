...
Uses an isolated service/save directory, explicit offline language rules, and two
fresh player processes. No fabricated client snapshots or headset claims.
"""
import copy
import datetime
import json
...
def main():
    ...
    service = Server(("127.0.0.1", 0), State(save_directory))
    ...
    try:
        ...
        wait(lambda state: not state["online"], seconds=LEASE_SECONDS + 8, require_player=False)
