...
$editorNames = @('WhiteRoomSceneSetup', 'MiniatureCatalog', 'WhiteRoomXrSetup', 'WhiteRoomPreview', 'SandboxCoreChecks', 'SandboxContentChecks', 'SandboxContentPackExporter', 'SandboxPrefabPreview', 'PolyHavenPrefabExporter')
